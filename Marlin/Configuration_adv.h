 ...
 */
#define E0_AUTO_FAN_PIN 7                                  // vchrisb
...
//
#define NUM_Z_STEPPER_DRIVERS 2   // (1-4) Z options change based on how many            // vchrisb
...
#define QUICK_HOME                            // If G28 contains XY do a diagonal move first       // vchrisb
...
// @section bltouch
   ...
   */
  #define BLTOUCH_SET_5V_MODE                              // vchrisb
 ...
 */
#define Z_STEPPER_AUTO_ALIGN                               // vchrisb
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING                            // vchrisb
...
// LCD Print Progress options
  ...
  #define LONG_FILENAME_HOST_SUPPORT                               // vchrisb
   ...
   */
  #define AUTO_REPORT_SD_STATUS                            // vchrisb
   ...
   */
  #define SDCARD_CONNECTION ONBOARD                        // vchrisb
...
#define BABYSTEPPING                                       // vchrisb
  ...
  #define BABYSTEP_ZPROBE_OFFSET            // Combine M851 Z and Babystepping           // vchrisb
 ...
 */
#define LIN_ADVANCE                                                                      // vchrisb
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.13    // Unit: mm compression per 1mm/s extruder speed         // vchrisb
...
#define TX_BUFFER_SIZE 16                                  // vchrisb
 ...
 */
#define EMERGENCY_PARSER                                   // vchrisb
...
#define SERIAL_FLOAT_PRECISION 4                           // vchrisb
 ...
 */
#define ADVANCED_PAUSE_FEATURE                             // vchrisb
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change.                                     // vchrisb
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.          // vchrisb
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)         // vchrisb
 ...
 */
#define AUTO_REPORT_POSITION                               // vchrisb
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT                             // vchrisb
#endif
...
#define M114_DETAIL           // Use 'M114` for details to check planner calculations              // vchrisb
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE     // Report the new fan speed when changed by M106 (and others)        // vchrisb
 ...
 */
#define HOST_ACTION_COMMANDS                               // vchrisb
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76
  #define HOST_PROMPT_SUPPORT                              // vchrisb
